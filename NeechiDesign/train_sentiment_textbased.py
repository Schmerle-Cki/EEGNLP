...
def train_model_ZuCo(dataloaders, device, model, criterion, optimizer, scheduler, num_epochs=25, checkpoint_path_best = './checkpoints/text_sentiment_classifier/best/test.pt', checkpoint_path_last = './checkpoints/text_sentiment_classifier/last/test.pt'):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'dev']:
            ...
            # Iterate over data.
            for input_word_eeg_features, seq_lens, input_masks, input_mask_invert, target_ids, target_mask, sentiment_labels, sent_level_EEG, raw_eeg, sentence, subject in tqdm(dataloaders[phase]):
...
if __name__ == '__main__':
    ...
    if dataset_name == 'ZuCo':
        ...
        SST_SENTIMENT_LABELS = json.load(open('./datasets/stanfordsentiment/ternary_dataset.json'))
