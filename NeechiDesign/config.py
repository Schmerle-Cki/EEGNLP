...
def get_config(case):
    if case == 'train_decoding': 
        ...
        parser.add_argument('-beta', '--contrastive_weight', type = float, help='weight for calculating contrastive loss', default = 0.001, required=False)
        ...
        parser.add_argument('-wd_weight', '--wd_weight', type = float, help='weight for calculating wasserstein distance', default = 10.0, required=False)
